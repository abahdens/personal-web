...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Gallery card styling - PERUBAHAN UTAMA DISINI */
        .gallery-grid {
            display: grid;
    ...
    <header class="header text-white py-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center px-4">
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-xl md:text-2xl font-bold">Kelola Gallery</h1>
            </div>
                ...
                <div class="p-5 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mt-1">Kelola gambar-gambar di galeri Anda</p>
                        </div>
                        <a href="add_gallery.php" class="add-btn">
                ...
                <div class="p-5">
                    ...
                    if (mysqli_num_rows($query) > 0) {
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            echo '<img src="../images/' . htmlspecialchars($data['foto']) . '" class="gallery-image" alt="' . htmlspecialchars($data['judul']) . '">';
                            echo '</div>';
                            echo '<div class="gallery-card-body">';
                            echo '<h3 class="gallery-card-title">' . htmlspecialchars($data['judul']) . '</h3>';
                            echo '<div class="gallery-card-actions">';
                            echo '<a href="edit_gallery.php?id_gallery=' . $data['id_gallery'] . '" class="action-btn edit-btn">';
                            echo '<i class="fas fa-edit mr-1"></i> Edit';
                            echo '</a>';
                            echo '<a href="delete_gallery.php?id_gallery=' . $data['id_gallery'] . '" onclick="return confirm(\'Yakin ingin menghapus gambar ini?\')" class="action-btn delete-btn">';
                        ...
                        echo '<i class="fas fa-image text-4xl text-blue-500 dark:text-blue-400"></i>';
                        echo '</div>';
                        echo '<h3 class="text-xl font-medium text-gray-800 dark:text-gray-200 mb-2">Belum Ada Gambar</h3>';
                        echo '<p class="text-gray-600 dark:text-gray-400 mb-6">Mulai dengan menambahkan gambar pertama Anda</p>';
                        echo '<a href="add_gallery.php" class="add-btn inline-flex">';
                        echo '<i class="fas fa-plus"></i>';
                        echo '<span>Tambahkan Gambar</span>';
                        echo '</a>';
                        echo '</div>';
                    }
                    ?>
