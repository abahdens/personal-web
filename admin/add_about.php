...
<head>
    ...
    <title>Tambah About - Admin Panel</title>
    ...
    <header class="header text-white py-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center px-4">
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-xl md:text-2xl font-bold">Tambah Data About</h1>
            </div>
            ...
            <div class="content-card">
                <div class="p-5 border-b border-gray-200 dark:border-gray-700">
                    <h2 class="text-xl md:text-2xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
                        ...
                        <span>Formulir Tambah About</span>
                    </h2>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">Isi form berikut untuk menambahkan data tentang diri Anda</p>
                </div>
                    ...
                    <form action="proses_add_about.php" method="post" class="space-y-6">
                        <div>
                            ...
                            <textarea id="about" name="about" rows="8" required
                                class="form-input focus:ring-2 focus:ring-blue-500"></textarea>
                        </div>
